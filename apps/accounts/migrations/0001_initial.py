# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-25 11:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('residency_year', models.PositiveIntegerField(verbose_name='Residency year')),
                ...
                ('specialities', models.ManyToManyField(to='accounts.Speciality', verbose_name='Specialities')),
            ],
            options={
