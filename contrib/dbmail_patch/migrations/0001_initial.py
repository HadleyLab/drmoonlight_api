# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-13 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', ckeditor.fields.RichTextField(help_text='Basic template for mail messages. {{content}} tag for msg.', verbose_name='Body')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', ckeditor.fields.RichTextField(verbose_name='Body')),
